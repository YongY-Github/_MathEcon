...
\subsection{6. Derivative at a Point}
...
\subsection{7. Derivative as a Function}
...
\subsection{8. Second Derivative}
...
\subsection{9. Basic Rules of Differentiation}
...
\begin{framed}
\textbf{\textbf{Chain Rule for Exponential and Logarithmic Functions}}\\
\subsubsection{The general exponential function rule}
...
\subsubsection{The general natural logarithmic function rule}
...
\subsection{11. The Differential}
...
\subsection{12. Taylor Series (Preview)}
...
\subsection{13. Implicit Differentiation}

\subsection{14. Inverse Function Rule for Implicit Functions}

\subsection{13. Some Uses of Differentiation in Economics}