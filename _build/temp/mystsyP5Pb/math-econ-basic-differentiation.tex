...
Define $dx$ as an arbitrary change in $x$fro its initial value $x_0$ and $dy$ as teh resulting change in $y$ \textbf{along the tangent line} from the initial value of the function $y_0 = f(x_0)$.
...
\includegraphics[width=3\linewidth]{files/differential-f7d2e5020308f284629d60620c354fff.png}
...
\includegraphics[width=5\linewidth]{files/TaylorSeries-0c3885452d97e129a2e638458f8ab3d8.png}
...
\textit{\textbf{Elasticity of substitution}}
