...
:::{math}
:enumerated: false
\frac{\partial y}{\partial x_1} = 48x_1^3 - 12x_1x_2,
\qquad
...
:::{math}
:enumerated: false
\frac{\partial y}{\partial x_1} = 6x_1x_2 + 24x_1,
\qquad
...
:::{math}
:enumerated: false
\frac{\partial y}{\partial x_1} = 6x_2^2 e^{3x_1},
\qquad
...
:::{math}
:enumerated: false
\frac{\partial y}{\partial x_1} = 2x_1 + 2\sqrt{x_2},
\qquad
...
:::{math}
:enumerated: false
\left.\frac{\partial y}{\partial x_1}\right|_{(1,4)} = 0,
\qquad
...
:::{math}
:enumerated: false
\left.\frac{\partial y}{\partial x_1}\right|_{(1,4)} = 88,
\qquad
...
:::{math}
:enumerated: false
\left.\frac{\partial y}{\partial x_1}\right|_{(1,4)} = 18,
\qquad
...
:::{math}
:enumerated: false
\left.\frac{\partial y}{\partial x_1}\right|_{(1,4)} = 1928,
\qquad
...
:::{math}
:enumerated: false
\left.\frac{\partial y}{\partial x_1}\right|_{(1,4)} = -2,
\qquad
...
:::{math}
:enumerated: false
\left.\frac{\partial y}{\partial x_1}\right|_{(1,4)} = 6,
\qquad
...
:::{math}
:enumerated: false
Z = f(x,y,u) = 2x^3 - 3xy^2 + 0.75yu - 5u^2,
:::
...
\frac{\partial Z}{\partial v}
=
(3ax^2 - 2bxy)\theta + (-bx^2 + c)(-2\gamma v).
:::
...
**(I)** $dw = (4x + \tfrac{1}{2}y),dx + (\tfrac{1}{2}x - 9y^2),dy$

**(ii)** $dw = \left(12x_1^2 - \frac{1}{x_1}\right),dx_1 + \left(6 - \frac{1}{x_2}\right),dx_2$

**(iii)** $dz = \dfrac{2xy^3 + x^2y}{(y^3 + xy)^2},dx - \dfrac{3x^2y^2 + x^3}{(y^3 + xy)^2},dy$

**(iv)** $dy = (4x_1 e^{3x_2}),dx_1 + (6x_1^2 e^{3x_2}),dx_2$
...
**(ii)** $\Delta y = 7007$, $dy = -2194$

**(iii)** $\Delta y = 19.3$, $dy = 6$

**(iv)** $dy = 2x,dx + \tfrac{1}{2}e^{z/2},dz = 4 - \tfrac{1}{2}e = 2.64$. Actual change is $\Delta y = 3.93$
...
:::{math}
:enumerated: false
F(x,y) = x^2 + y^2 + (xy)^{1/3} = 0
:::

**(ii)**  
:::{math}
:enumerated: false
F(x,y) = x^2 y + y^2 x + xy = 0
:::

**(iii)**  
:::{math}
:enumerated: false
F(x,y) = \ln x^3 + (xy)^2 - 4y = 0
:::

**(iv)**  
:::{math}
:enumerated: false
F(x,y,w) = w^3 y^3 + x^2 + wxy + 7 = 0
:::

Find $\partial y / \partial x$.
