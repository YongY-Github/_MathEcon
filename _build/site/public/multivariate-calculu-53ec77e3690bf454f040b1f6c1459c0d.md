...
A positive cross partial derivative means that capital and labor are
*complements*: increasing the use of one input raises the marginal productivity
of the other. At the same time, the negative second partial derivatives capture
diminishing marginal productivity of each input on its own.
::::
