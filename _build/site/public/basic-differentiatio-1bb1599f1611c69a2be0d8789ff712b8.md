...
$$
\begin{aligned}
\text{(i)}\;& f'(x)=4x^3-9x^2+14x+3 \quad
\text{(ii)}\;& f'(x)=198(2x+4)^{98} \quad
\text{(iii)}\;& f'(x)=(200x+200)(5x^2+10x+3)^{19} \\[6pt]
\text{(iv)}\;& f'(x)=ab\,e^{abx} \quad
\text{(v)}\;& f'(x)=ab\,x^{a-1}e^{bx^a} \quad
\text{(vi)}\;& f'(x)=10(b+2cx)(e^{a+bx+cx^2})^{10}
\end{aligned}
$$



**Practice Examples: Derivatives of Exponential and Logarithmic Functions**
...
---
**2. General Natural Logarithmic Rule**
...
---
**4. Comparison of $\ln(ax)$ vs $\ln(x^n)$**
