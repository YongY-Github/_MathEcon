...
:::{math}
:enumerated: false
\fracd}{d x}(a^{g(x)}) = a^{g(x)} g'(x) \ln a, \text{ where } a > 0, a \neq 0
:::
...
$$\frac{\partial}{\partial x} \ln(x^2) = \frac{\partial}{\partial(x^2)} \ln(x^2) \frac{\partial}{\partial x}(x^2) = \frac{1}{x^2} 2x = 2/x$$
...
$$\frac{\partial}{\partial x} \log_b(x) = \frac{1}{x} \frac{1}{\ln(b)}$$

**Or more generally**

$$\begin{aligned} 
\frac{\partial}{\partial x} \log_b g(x) &= \frac{g'(x)}{g(x)} \frac{1}{\ln b}, \text{ where } b > 0, b \neq 1 \\ 
&= \frac{g'(x)}{g(x)} \log_b e 
\end{aligned}$$

**note that** $\log_b e = \frac{1}{\ln b}$.
