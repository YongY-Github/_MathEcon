...
<img src="figs/TaylorSeries.png" alt="Taylor Series" width="300"/>
...
A better approximation would be a linear function of the form $h(x) = f(a) + (x-a)$. But what would be the
best value of b? We saw above that the differential is an equation for the tangent line (or slope) at the point
x = a. Hence, we could argue that the best linear approximation to the function around this point would be
