...
+
f(x,y)\frac{\partial g}{\partial x}, \\[2em]
\frac{\partial}{\partial y}[f(x,y)g(x,y)]
&=
g(x,y)\frac{\partial f}{\partial y}
+
f(x,y)\frac{\partial g}{\partial y}.
\end{aligned}
$$
...
&=
\frac{h(x, y) \cdot \frac{\partial g}{\partial x} 
- g(x, y) \cdot \frac{\partial h}{\partial x}}{[h(x, y)]^2}, \\[2em]
\frac{\partial}{\partial y} \left[ \frac{f(x,y)}{g(x,y)} \right] 
&= \frac{h(x, y) \cdot \frac{\partial g}{\partial y} 
- g(x, y) \cdot \frac{\partial h}{\partial y}}{[h(x, y)]^2}
\end{aligned}
$$
...
&= n [g(x, y)]^{n-1} \frac{\partial [g(x,y)]^n}{\partial x}, \\[2em]
\frac{\partial [g(x,y)]^n}{\partial y}
&= n [g(x, y)]^{n-1} \frac{\partial [g(x,y)]^n}{\partial y}
$$
