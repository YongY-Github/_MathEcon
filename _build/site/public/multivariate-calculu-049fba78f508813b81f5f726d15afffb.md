...
+ h(x, y) \frac{\partial g}{\partial x}, \quad
\frac{\partial}{\partial y}[f(x,y)g(x,y)]
 = g(x, y) \frac{\partial h}{\partial y} + h(x, y) \frac{\partial g}{\partial y}
$$
...
= \frac{h(x, y) \cdot \frac{\partial g}{\partial x} - g(x, y) \cdot \frac{\partial h}{\partial x}}{[h(x, y)]^2}
:::
