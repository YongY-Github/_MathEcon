...
$$
y = f(x_1,x_2) = 12x_1^4 - 6x_1^2x_2 + 4x_2^3
$$

### (ii)

$$
y = f(x_1,x_2) = (3x_1^2 + 5x_2 + 1)(x_2 + 4)
$$

### (iii)

$$
y = f(x_1,x_2) = \frac{7x_1 - x_1x_2^2}{x_1 - 2}
$$

### (iv)

$$
y = f(x_1,x_2) = (2e^{x_1})(e^{2x_1}x_2^2)
$$

### (v)

$$
y = f(x_1,x_2) = 2\ln(3x_1) - 4\ln(2x_1x_2)
$$

### (vi)

$$
y = f(x_1,x_2) = x_1^2 + 2x_1x_2^{1/2} - 4x_2
$$
...
## 2. Second-Order and Cross Partial Derivatives

For each function in **Question 1**, compute:
