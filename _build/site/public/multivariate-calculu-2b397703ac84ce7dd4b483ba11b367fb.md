...
dy
=
f_1(x_1^0, x_2^0, \ldots, x_n^0)\,dx_1
+
f_2(x_1^0, x_2^0, \ldots, x_n^0)\,dx_2
+
\cdots
+
f_n(x_1^0, x_2^0, \ldots, x_n^0)\,dx_n,
:::

where $f_i(x_1^0, x_2^0, \ldots, x_n^0)$ represents the partial derivative of the
function $f(x_1, x_2, \ldots, x_n)$ with respect to its $i$th argument, evaluated
at the point $(x_1^0, x_2^0, \ldots, x_n^0)$.
...
We can take higher-order total differentials if required. Continuing with the
same example, the second-order total differential is  
...
Thus, the chain rule can be interpreted as applying the total differential to
situations in which the arguments of a multivariate function depend on an
