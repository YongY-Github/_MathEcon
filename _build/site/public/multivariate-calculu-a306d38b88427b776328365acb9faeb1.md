...
where $f_i = \displaystyle \frac{\partial y}{\partial x_i}$.
...
are themselves differentiable functions of the variables $t_1, \ldots, t_m$ such that

:::{math}
:enumerated: false
x_1 = g^1(t_1, \ldots, t_m), \quad
x_2 = g^2(t_1, \ldots, t_m), \quad
\ldots, \quad
x_n = g^n(t_1, \ldots, t_m),
:::

where $g^i(t_1, \ldots, t_m)$ is the $i$th function, then
...
::::{admonition} Multivariate Chain Rule
:class: important
...
y = f(x_1, x_2, \ldots, x_n)
$$
be a differentiable function, where each argument depends on a single variable $t$:
$$
x_1 = g^1(t), \quad x_2 = g^2(t), \quad \ldots, \quad x_n = g^n(t).
$$

Then the derivative of $y$ with respect to $t$ is
$$
\frac{dy}{dt}
=
...
This formula combines **partial derivatives** (how $f$ responds to each argument)
with **ordinary derivatives** (how each argument changes with $t$).
::::
