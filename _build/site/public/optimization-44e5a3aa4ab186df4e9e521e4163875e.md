...
Note that you can actually use $Ax=b$ i.e. $x=A^{-1}b$, which is recommended for more complex system of equations.
...
*(Note: Corrected $6y^2$ to $6x^2$ based on provided answer key)*
