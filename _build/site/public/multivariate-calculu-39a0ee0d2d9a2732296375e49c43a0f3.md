...
\frac{F_{x_i}(y^0, x_1^0, x_2^0, \ldots, x_n^0)}
{F_y(y^0, x_1^0, x_2^0, \ldots, x_n^0)}.
:::
...
* add a **Hessian-based version of Euler’s theorem**, or
* explicitly connect **total derivatives ↔ multivariate chain rule ↔ total differentials** in one boxed summary for students.
