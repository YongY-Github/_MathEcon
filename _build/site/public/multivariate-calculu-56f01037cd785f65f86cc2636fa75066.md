...
* \frac{g'(y) f_1(sx_1,sx_2)}{g'(y) f_2(sx_1,sx_2)} [0.5em]
  &=
* \frac{f_1(sx_1,sx_2)}{f_2(sx_1,sx_2)} [0.5em]
  &=
* \frac{s^{k-1} f_1(x_1,x_2)}{s^{k-1} f_2(x_1,x_2)} [0.5em]
...
* add a **diagram-based intuition box** (isoquants & rays),
* link this explicitly to **MRTS** and cost minimization, or
* compress this into a **one-page “exam summary” box**.
