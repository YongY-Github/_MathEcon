...
Define $dx$ as an arbitrary change in $x$fro its initial value $x_0$ and $dy$ as teh resulting change in $y$ along the tangent line from the initial value of the fubction 
